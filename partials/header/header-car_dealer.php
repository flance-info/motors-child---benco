...
if (!is_wp_error($user) && !empty($user->data->ID)) {
	$stm_account_page_link = (apply_filters('stm_is_listing_five', false) && function_exists('stm_c_f_get_page_url')) ? stm_c_f_get_page_url('account_page') : stm_get_author_link($user->data->ID);
} else {
	$stm_account_page_link = (apply_filters('stm_is_listing_five', false) && function_exists('stm_c_f_get_page_url')) ? stm_c_f_get_page_url('account_page') : stm_get_author_link('register');
}

$stm_account_page_link = (apply_filters('stm_is_listing_six', false)) ? stm_c_six_get_page_url('account_page') : $stm_account_page_link;
...
?>
	...
	<div class="header-main <?php echo (wp_is_mobile()) ? 'header-main-mobile' : ''; ?>">
		<div class="container">
			<div class="clearfix">
				<!--Logo-->
				<div class="logo-main <?php echo ($show_add_btn) ? 'showing_add_btn' : ''; ?> <?php echo ($header_profile) ? 'showing_profile_btn' : ''; ?>"
						...
						<div class="mobile-contacts-trigger visible-sm visible-xs">
							...
							<div class="pull-right" style="width: 100%;">
								<div class="header-main-phone heading-font">
									...
									<div class="phone">
										<span class="phone-label">Benco:</span>
										<span class="phone-number heading-font"><a
												href="tel:450-658-1802">450-658-1802</a></span>
									</div>
								</div>
							</div>
							...
							<div class="pull-right" style="width: 100%;">
								<div class="header-main-phone heading-font">
									<i class="stm-icon-phone"></i>
									<div class="phone">
										<span class="phone-label">Location Benoit:</span>
										<span class="phone-number heading-font"><a
												href="tel:450-658-2433">450-658-2433</a></span>
									</div>
								</div>
							</div>
